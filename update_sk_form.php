...
<div class="container-fluid">
    ...
    <h1 class="mb-4 text-center">SK Official's Data</h1>
    ...
    <div class="col-md-8">
        <div class="card"> 
            <div class="card-header bg-primary text-white"> Update SK Official's Data </div>
            <div class="card-body"> 
                <form method="post">
                    <div class="row">
                        <div class="col">
                    ...
                    <br>
                    <hr>
                    <center><button class="btn btn-primary" type="submit" name="update_sk" style="width: 120px; font-size: 18px; border-radius:5px;">
                        Update 
                    </button>
                    <a href="sk_officials.php" class="btn btn-danger" style="width: 120px; font-size: 18px; border-radius:5px;"> Back </a></center>
                </form>         
            </div>
        </div>
    </div>
