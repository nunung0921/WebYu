...
?>
                        <p style="text-indent:40px;text-align: justify;">Issued this <ins><?= date('jS');?></ins> day of <ins><?= date('F');?></ins>, 2024, here at Barangay Yuson, Guimba, Nueva Ecija.</p><br>
                        ...
                        <div style="display: flex;">
                            <div style="flex: 1;">
                                ...
                                <label style="font-size:14px;margin-left:1.5em;"><u>RENATO S. CONCEPCION SR.</u></label>
                ...
                <div class="col-xs-8 col-md-4" style="margin-top: 3em;"><br>
                    ...
                    <b><span style=" text-align: center;">Barangay Official Receipt No.: </b> ___________</span><br><br><br>
