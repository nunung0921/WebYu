                                ...
                                <div class="row"> 
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input name="lname" type="text" class="form-control" value="<?= $userdetails['surname']?>" pattern="[a-zA-Z\-'\s]{1,}$" title="Please enter a valid last name (only letters, hyphens, apostrophes, and spaces allowed)" required>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input name="fname" type="text" class="form-control" value="<?= $userdetails['firstname']?>" pattern="^[a-zA-Z\-'\s]{1,}$" title="Please enter a valid first name (only letters, hyphens, apostrophes, and spaces allowed)" required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>  
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input name="age" type="number" class="form-control" value="<?= $userdetails['age']?>" pattern="^(?:1[01][0-9]|120|1[6-9]|[2-9][0-9])$" title="Please enter a valid age (only numbers allowed)" required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
